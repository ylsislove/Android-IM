package com.yain.controller.adapter;
...
public class InviteAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            hodler.accept = convertView.findViewById(R.id.bt_invite_accept);
            hodler.reject = convertView.findViewById(R.id.bt_invite_reject);
        ...
        if (user != null) {// 联系人
            ...
            // 按钮的处理
            hodler.accept.setOnClickListener(v -> mOnInviteListener.onAccept(invationInfo));
            // 拒绝按钮的点击事件处理
            hodler.reject.setOnClickListener(v -> mOnInviteListener.onReject(invationInfo));
            ...
            switch(invationInfo.getStatus()){
                ...
                case NEW_GROUP_INVITE:
                    ...
                    hodler.reject.setVisibility(View.VISIBLE);
                    // 接受邀请
                    hodler.accept.setOnClickListener(v -> mOnInviteListener.onInviteAccept(invationInfo));
                    // 拒绝邀请
                    hodler.reject.setOnClickListener(v -> mOnInviteListener.onInviteReject(invationInfo));
                ...
                case NEW_GROUP_APPLICATION:
                    ...
                    hodler.reject.setVisibility(View.VISIBLE);
                    // 接受申请
                    hodler.accept.setOnClickListener(v -> mOnInviteListener.onApplicationAccept(invationInfo));
                    // 拒绝申请
                    hodler.reject.setOnClickListener(v -> mOnInviteListener.onApplicationReject(invationInfo));
