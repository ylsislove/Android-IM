    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(mIsCanModify) {// 群主或开放了群权限
            ...
            if(position == getCount() - 1) {// 减号
                ...
                holder.photo.setOnClickListener(v -> mOnGroupDetailListener.onAddMembers());
            }else {
                holder.delete.setOnClickListener(v -> mOnGroupDetailListener.onDeleteMember(userInfo));
            }
        }else {// 普通的群成员
